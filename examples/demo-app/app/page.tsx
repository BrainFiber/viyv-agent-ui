	...
	return (
		<div className="space-y-10">
			...
			<section className="rounded-lg border border-gray-200 bg-white p-6">
				<h2 className="text-lg font-semibold">動的ページ作成</h2>
				<p className="mt-1 text-sm text-gray-500">
				...
				<div className="mt-4 space-y-4">
					<div>
						<h3 className="text-sm font-medium text-gray-700">1. ページを作成</h3>
...
{`curl -X POST http://localhost:3100/api/agent-ui/pages \\
  ...
  -d '{
    ...
    "actions": {}
					...
					<div>
						<h3 className="text-sm font-medium text-gray-700">2. ブラウザで確認</h3>
						<p className="mt-1 text-sm text-gray-500">
							作成後、{' '}
					...
					<div>
						<h3 className="text-sm font-medium text-gray-700">3. プレビュー (一時保存)</h3>
						<pre className="mt-2 overflow-x-auto rounded bg-gray-900 p-4 text-sm text-green-400">
